...
import *as mainAction from '../../actions/mainAction';// 导入action方法
            ...
            <View style={mainStyle.container}>
                ...
                <View style={{flex:754}}>
                    ...
                    <View style={{flex:204,flexDirection:'row'}}>
                        <View style={{flex:41}}/>
                        <TouchableHighlight underlayColor={'rgba(0,0,0,0)'} onPress={()=>{this.props.navigation.navigate('ServiceSchoolList',{token:'我就是测试来的'});}} style={{flex:220}}>
...
export default connect(
    ...
    (dispatch) => ({
        FetchSwiperData: () => dispatch(mainAction.FetchSwiperData())
    })
)(MainPage)
